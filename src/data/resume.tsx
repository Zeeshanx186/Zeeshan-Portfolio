...
export const DATA = {
  ...
  description:
    "Systems Engineer specializing in Industrial Automation and AI-based Vision Systems.",
  summary:
    "In 2024, I joined The Automators Pvt Ltd to work on Honeywell DCS and Siemens PLCs at industrial sites like sugar mills and distilleries. In the past, [I graduated in Electrical Engineering (Electronics) from Sukkur IBA University](#education), [developed a YOLOv8-based vision system for fabric defect detection], and [worked in power and control systems across various industries]. My final year project was funded by NGIRI and awarded 1st prize in SIBA Fest's circuit design competition.",
